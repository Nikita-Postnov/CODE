...
class SpellCheckerApp:
    ...
    def show_about(self):
        ...
        text = tk.Text(about_window, wrap=tk.WORD, height=10, width=40)
        ...
        url = "https://github.com/Nikita-Postnov"
        text.insert(tk.END, url, "hyperlink")
        
        text.tag_config("hyperlink", foreground="blue", underline=True)
        text.tag_bind("hyperlink", "<Button-1>", lambda e: webbrowser.open_new(url))
